...
var dateInput = document.querySelector('input#datetime-picker');
var startBtn = document.querySelector('button[data-start]');
...
(0, _flatpickr.default)(dateInput, options);

function onSelectDate(selectedDates) {
  var currentTime = new Date().getTime();
  var rawSelectedDate = selectedDates[0].getTime();
...
startBtn.addEventListener('click', function () {
  ...
  intervalId = setInterval(function () {
    ...
    var timeToEnd = convertMs(selectedDate - timeNow);
    var timeToEndToString = addLeadingZero(timeToEnd);
    renderTime(timeToEndToString);
  }, 1000);
});

function renderTime(_ref) {
  var days = _ref.days,
      hours = _ref.hours,
      minutes = _ref.minutes,
      seconds = _ref.seconds;
  var dateDays = document.querySelector('.value[data-days]');
  var dateHours = document.querySelector('.value[data-hours]');
  var dateMinutes = document.querySelector('.value[data-minutes]');
  var dateSeconds = document.querySelector('.value[data-seconds]');
...
function addLeadingZero(time) {
  return {
    days: "".concat(time.days).padStart(2, '0'),
    hours: "".concat(time.hours).padStart(2, '0'),
    minutes: "".concat(time.minutes).padStart(2, '0'),
    seconds: "".concat(time.seconds).padStart(2, '0')
  };
}
