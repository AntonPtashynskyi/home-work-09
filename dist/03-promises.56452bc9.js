...
var firstDelay = document.querySelector('input[name="delay"]');
var delayStep = document.querySelector('input[name="step"]');
...
function onSubmitBtnClick(evt) {
  evt.preventDefault();
  var position = Number(amount.value);
  var nextDelay = Number(delayStep.value);
  var delay = Number(firstDelay.value);
